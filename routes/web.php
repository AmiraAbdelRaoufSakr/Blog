...
Route::get('/auth/google/redirect',[GoogleUserController::class, 'redirectToProvider']);
Route::get('/auth/google/callback',[GoogleUserController::class, 'handleProviderCallback']);
